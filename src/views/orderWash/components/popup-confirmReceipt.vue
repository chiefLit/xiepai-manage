                ...
                <div class="value">
                  <template v-for="(sub, subIndex) in item.serviceDetailList">
                    <div
                      class="mr20"
                      :key="subIndex"
                      v-if="sub.classifyCode === '000001'"
                    >{{sub.serviceName}} {{sub.price}}</div>
                  </template>
                </div>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="0" v-if="formParams.storeCollectSubParamList">
              <el-col :span="6">
                <el-form-item label="鞋子品牌">
                  <el-input
                    v-model="formParams.storeCollectSubParamList[index].brand"
                    placeholder="请输入"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="具体型号">
                  <el-input
                    v-model="formParams.storeCollectSubParamList[index].model"
                    placeholder="请输入"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="估算二手市场价">
                  <el-input
                    v-model="formParams.storeCollectSubParamList[index].amount"
                    placeholder="请输入"
                  ></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="备注">
                  <el-input
                    ...
                    :rows="2"
                    placeholder="请输入内容"
                    v-model="formParams.storeCollectSubParamList[index].remark"
                  ></el-input>
                </el-form-item>
              </el-col>
            </el-row>
...
export default {
  ...
  methods: {
    ...
    calcParams() {
      ...
      for (
        let i = 0;
        i < this.formParams.storeCollectSubParamList.length;
        i++
      ) {
